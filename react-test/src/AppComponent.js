  ...
  return (
    <div className="App">
      ...
      <div className="modal-container">
        ...
        <div className="info">
          <a target="_blank" className="social github-icon" href="https://github.com/acamposruiz/jsTestsByGamming/blob/master/react-test/src/App.js">
            <img className="img-social" alt="Github" src={logoGithub}/> <span>View source code</span>
          </a>
        </div>
      </div>
      <div className="back-container">
        <a title="Go back" className="back-link" href="https://acamposruiz.github.io/jsTestsByGamming/builds/home/index.html">
